...
const Privacy = () => {
  useEffect(() => {
    document.title = "Privacy - Our Rajasthan Taxi Service Bikaner";
  }, []);
  return (
    <>
      <main>
        <FrontHeadB name="Privacy" />
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Our Rajasthan Taxi Service Bikaner.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Our Rajasthan Taxi Service
                Bikaner, accessible from{" "}
                <a
                  href="https://ourrajasthantaxiservicebikaner.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  <span className="theme-golden">
                    https://ourrajasthantaxiservicebikaner.com/
                  </span>
                </a>
              </p>
            </li>
          ...
          <ul>
            <li>
              <p>
                ...
                <a
                  href="https://ourrajasthantaxiservicebikaner.com/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                >
            ...
            <li>
              <p>By phone number: +91 81188 30211</p>
            </li>
          </ul>
        </section>
      </main>
